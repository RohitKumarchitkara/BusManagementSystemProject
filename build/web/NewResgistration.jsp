...
<nav>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td data-label="User ID"><%=(ri.get(i)).getUid() %></td>
      <td data-label="User Name"><%= (ri.get(i)).getName() %></td>
      <td data-label="Password"><%= (ri.get(i)).getPassword() %></td>
      <%
      ...
      <td data-label="Status"><a href="grantPermission?roll=<%= (ri.get(i)).getUid() %>&sto=<%= (ri.get(i)).getRoute() %>">Accept</a><<a href="revokePermission?roll=<%= (ri.get(i)).getUid() %>" id="rem">Remove</a></td>
      <%
          }
          else{
      %>
