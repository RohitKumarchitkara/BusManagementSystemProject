        ...
        <div class="login-wrap">
            <div class="login-html">
                ...
                <div class="login-form">
                    <form name="myform" action="facultyservlet" method="post" onsubmit="return myValidation()">
                        <div class="sign-in-htm">
                            <div class="group">
                                <label for="user" class="label"><font color="white">Email</font></label>
...
<!--                            <div class="group">
                    ...
                    <form name="myform1" action="facultySign" method="post" onsubmit="return myValidation1()">
                        <div class="sign-up-htm">
                            <div class="group">
                                <label for="user" class="label"><font color="white">Faculty Name</font></label>
                                <input name="username" id="user" type="text" class="input">
                            </div>
                            <div class="group">
                                <label for="pass" class="label"><font color="white">Faculty ID</font></label>
