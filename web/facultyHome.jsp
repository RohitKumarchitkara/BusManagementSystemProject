    ...
    <div class="login-box">
        <center><img src="a1.png" height="100px" width="100px"></center><br>
                    <form action="searchServlet" method="post">
                        ...
                        <center><b>Route Name</b> <br><input type ="text" name="rname" required></center><br>
                        
                      
                        <center><b>Route Code</b> :<br><input type ="text" name="rcode" required></center><br>
...
<div id="login-box1">
   ...
   %>
    <center>
        <img src="a1.png" height="100px" width="100px"><br><br><b>Faculty</b>
        <br><br>
        <a href="viewProfile?rd=<%= sid %>"> <button class="bt1"><b>Profile</b></button></a><br><br>
    <a href="viewRouteServlet"> <button class="bt1"><b>Routes Information</b></button></a><br><br>
