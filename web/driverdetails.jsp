...
<html>
  ...
  outline: none;
    ...
    <body>
        <div class="main">
        <div class="header">
            <h1><b><center>Driver Details</center></b></h1>
        </div>
        </div>
            <div class="con">
                ...
                <div class="B">
                    <br><br><br>
                    <a href="driverupdate.jsp"> <button class="bt1"><b>Add Record</b></button></a><br><br><br>
                    <a href="viewrecord.jsp"><button class="bt1"><b>View Record</b></button></a><br><br><br>
                    <a href="deleteRecord.jsp"><button class="bt1"><b>Delete Record</b></button></a><br><br><br>
